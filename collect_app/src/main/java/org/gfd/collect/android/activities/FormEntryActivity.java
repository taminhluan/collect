...
package org.gfd.collect.android.activities;
...
import org.gfd.collect.android.adapters.IconMenuListAdapter;
import org.gfd.collect.android.adapters.model.IconMenuItem;
import org.gfd.collect.android.application.Collect;
import org.gfd.collect.android.dao.FormsDao;
import org.gfd.collect.android.dao.helpers.ContentResolverHelper;
import org.gfd.collect.android.dao.helpers.FormsDaoHelper;
import org.gfd.collect.android.dao.helpers.InstancesDaoHelper;
import org.gfd.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.gfd.collect.android.events.RxEventBus;
import org.gfd.collect.android.exception.JavaRosaException;
import org.gfd.collect.android.external.ExternalDataManager;
import org.gfd.collect.android.fragments.MediaLoadingFragment;
import org.gfd.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.gfd.collect.android.fragments.dialogs.FormLoadingDialogFragment;
import org.gfd.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.gfd.collect.android.fragments.dialogs.NumberPickerDialog;
import org.gfd.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.gfd.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.gfd.collect.android.listeners.AdvanceToNextListener;
import org.gfd.collect.android.listeners.FormLoaderListener;
import org.gfd.collect.android.listeners.FormSavedListener;
import org.gfd.collect.android.listeners.PermissionListener;
import org.gfd.collect.android.listeners.SavePointListener;
import org.gfd.collect.android.listeners.WidgetValueChangedListener;
import org.gfd.collect.android.location.client.GoogleLocationClient;
import org.gfd.collect.android.location.client.LocationClient;
import org.gfd.collect.android.location.client.LocationClients;
import org.gfd.collect.android.logic.AuditConfig;
import org.gfd.collect.android.logic.AuditEvent;
import org.gfd.collect.android.logic.FormController;
import org.gfd.collect.android.logic.FormController.FailedConstraint;
import org.gfd.collect.android.logic.FormInfo;
import org.gfd.collect.android.logic.ImmutableDisplayableQuestion;
import org.gfd.collect.android.preferences.AdminKeys;
import org.gfd.collect.android.preferences.AdminSharedPreferences;
import org.gfd.collect.android.preferences.GeneralKeys;
import org.gfd.collect.android.preferences.GeneralSharedPreferences;
import org.gfd.collect.android.preferences.PreferencesActivity;
import org.gfd.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.gfd.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.gfd.collect.android.tasks.FormLoaderTask;
import org.gfd.collect.android.tasks.SaveFormIndexTask;
import org.gfd.collect.android.tasks.SavePointTask;
import org.gfd.collect.android.tasks.SaveResult;
import org.gfd.collect.android.tasks.SaveToDiskTask;
import org.gfd.collect.android.upload.AutoSendWorker;
import org.gfd.collect.android.utilities.ActivityAvailability;
import org.gfd.collect.android.utilities.ApplicationConstants;
import org.gfd.collect.android.utilities.DependencyProvider;
import org.gfd.collect.android.utilities.DialogUtils;
import org.gfd.collect.android.utilities.FileUtils;
import org.gfd.collect.android.utilities.ImageConverter;
import org.gfd.collect.android.utilities.MediaManager;
import org.gfd.collect.android.utilities.MediaUtils;
import org.gfd.collect.android.utilities.PermissionUtils;
import org.gfd.collect.android.utilities.RegexUtils;
import org.gfd.collect.android.utilities.SnackbarUtils;
import org.gfd.collect.android.utilities.SoftKeyboardUtils;
import org.gfd.collect.android.utilities.ToastUtils;
import org.gfd.collect.android.views.ODKView;
import org.gfd.collect.android.widgets.DateTimeWidget;
import org.gfd.collect.android.widgets.QuestionWidget;
import org.gfd.collect.android.widgets.RangeWidget;
import org.gfd.collect.android.widgets.StringWidget;
...
import static org.gfd.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.gfd.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.gfd.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.gfd.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.gfd.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
