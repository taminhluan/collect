...
package org.gfd.collect.caferedd.activities;
...
import org.gfd.collect.caferedd.utilities.FormEntryPromptUtils;
...
import org.gfd.collect.caferedd.adapters.IconMenuListAdapter;
import org.gfd.collect.caferedd.adapters.model.IconMenuItem;
import org.gfd.collect.caferedd.application.Collect;
import org.gfd.collect.caferedd.dao.FormsDao;
import org.gfd.collect.caferedd.dao.helpers.ContentResolverHelper;
import org.gfd.collect.caferedd.dao.helpers.FormsDaoHelper;
import org.gfd.collect.caferedd.dao.helpers.InstancesDaoHelper;
import org.gfd.collect.caferedd.events.ReadPhoneStatePermissionRxEvent;
import org.gfd.collect.caferedd.events.RxEventBus;
import org.gfd.collect.caferedd.exception.JavaRosaException;
import org.gfd.collect.caferedd.external.ExternalDataManager;
import org.gfd.collect.caferedd.fragments.MediaLoadingFragment;
import org.gfd.collect.caferedd.fragments.dialogs.CustomDatePickerDialog;
import org.gfd.collect.caferedd.fragments.dialogs.FormLoadingDialogFragment;
import org.gfd.collect.caferedd.fragments.dialogs.LocationProvidersDisabledDialog;
import org.gfd.collect.caferedd.fragments.dialogs.NumberPickerDialog;
import org.gfd.collect.caferedd.fragments.dialogs.ProgressDialogFragment;
import org.gfd.collect.caferedd.fragments.dialogs.RankingWidgetDialog;
import org.gfd.collect.caferedd.listeners.AdvanceToNextListener;
import org.gfd.collect.caferedd.listeners.FormLoaderListener;
import org.gfd.collect.caferedd.listeners.FormSavedListener;
import org.gfd.collect.caferedd.listeners.PermissionListener;
import org.gfd.collect.caferedd.listeners.SavePointListener;
import org.gfd.collect.caferedd.listeners.WidgetValueChangedListener;
import org.gfd.collect.caferedd.location.client.GoogleLocationClient;
import org.gfd.collect.caferedd.location.client.LocationClient;
import org.gfd.collect.caferedd.location.client.LocationClients;
import org.gfd.collect.caferedd.logic.AuditConfig;
import org.gfd.collect.caferedd.logic.AuditEvent;
import org.gfd.collect.caferedd.logic.FormController;
import org.gfd.collect.caferedd.logic.FormController.FailedConstraint;
import org.gfd.collect.caferedd.logic.FormInfo;
import org.gfd.collect.caferedd.logic.ImmutableDisplayableQuestion;
import org.gfd.collect.caferedd.preferences.AdminKeys;
import org.gfd.collect.caferedd.preferences.AdminSharedPreferences;
...
import org.gfd.collect.caferedd.preferences.PreferencesActivity;
import org.gfd.collect.caferedd.provider.FormsProviderAPI.FormsColumns;
import org.gfd.collect.caferedd.provider.InstanceProviderAPI.InstanceColumns;
import org.gfd.collect.caferedd.tasks.FormLoaderTask;
import org.gfd.collect.caferedd.tasks.SaveFormIndexTask;
import org.gfd.collect.caferedd.tasks.SavePointTask;
import org.gfd.collect.caferedd.tasks.SaveResult;
import org.gfd.collect.caferedd.tasks.SaveToDiskTask;
import org.gfd.collect.caferedd.upload.AutoSendWorker;
import org.gfd.collect.caferedd.utilities.ActivityAvailability;
import org.gfd.collect.caferedd.utilities.ApplicationConstants;
import org.gfd.collect.caferedd.utilities.DependencyProvider;
import org.gfd.collect.caferedd.utilities.DialogUtils;
import org.gfd.collect.caferedd.utilities.FileUtils;
import org.gfd.collect.caferedd.utilities.ImageConverter;
import org.gfd.collect.caferedd.utilities.MediaManager;
import org.gfd.collect.caferedd.utilities.MediaUtils;
import org.gfd.collect.caferedd.utilities.PermissionUtils;
import org.gfd.collect.caferedd.utilities.RegexUtils;
import org.gfd.collect.caferedd.utilities.SnackbarUtils;
import org.gfd.collect.caferedd.utilities.SoftKeyboardUtils;
import org.gfd.collect.caferedd.utilities.ToastUtils;
import org.gfd.collect.caferedd.views.ODKView;
import org.gfd.collect.caferedd.widgets.DateTimeWidget;
import org.gfd.collect.caferedd.widgets.QuestionWidget;
import org.gfd.collect.caferedd.widgets.RangeWidget;
import org.gfd.collect.caferedd.widgets.StringWidget;
...
import static org.gfd.collect.caferedd.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.gfd.collect.caferedd.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.gfd.collect.caferedd.utilities.ApplicationConstants.RequestCodes;
import static org.gfd.collect.caferedd.utilities.PermissionUtils.finishAllActivities;
import static org.gfd.collect.caferedd.utilities.PermissionUtils.areStoragePermissionsGranted;
