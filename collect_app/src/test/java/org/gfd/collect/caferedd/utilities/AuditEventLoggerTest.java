...
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.BEGINNING_OF_FORM;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.CONSTRAINT_ERROR;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.DELETE_REPEAT;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.END_OF_FORM;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FINALIZE_ERROR;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FORM_EXIT;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FORM_FINALIZE;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FORM_RESUME;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FORM_SAVE;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.FORM_START;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.GOOGLE_PLAY_SERVICES_NOT_AVAILABLE;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.GROUP;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.HIERARCHY;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_NOT_GRANTED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_TRACKING_DISABLED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.PROMPT_NEW_REPEAT;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.QUESTION;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.REPEAT;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.SAVE_ERROR;
import static org.gfd.collect.caferedd.logic.AuditEvent.AuditEventType.UNKNOWN_EVENT_TYPE;
